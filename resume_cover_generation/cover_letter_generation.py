...
"""
        ...
        # served a cover letter generated by a different session — the
        # output folder used to be shared globally, which let stale or
        # unrelated sessions' files leak into someone else's chat.
        docx_dir = os.path.join(os.getcwd(), "output", "cover_letters", str(session_id))
